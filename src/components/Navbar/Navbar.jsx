...
const Navbar = () => {
    return (
        <nav className="fixed min-h-screen min-w-[4rem] bg-neutral-300 xl:w-[15%] 1700:w-[12%]">
            <div className="m-auto h-screen w-full">
                <div className="mt-8 text-center">DevCoin</div>
                <div className="mt-8 flex h-full flex-col justify-between xl:ml-8">
                    ...
                    <div className="flex -translate-y-[7rem] flex-col items-center gap-6 xl:items-start">
                        <NavLink
                            to="/settings"
                            className="navbar-links flex gap-x-6"
                            activeclassname="active"
                        ...
                        <div className="navbar-links flex gap-x-6">
                            ...
                            <span className="hidden xl:flex">Dark</span>
                        </div>
                        <NavLink
                            to="/login"
                            className="navbar-links flex gap-x-6"
