...
const Balance = ({user}) => {
    ...
    return (
        <div className=' text-white w-8/12'>
           <div className='flex   bg-secondary dark:bg-secondary/90 justify-center rounded-lg items-center my-10 mx-auto w-3/5 text-lg font-semibold px-3 py-1 sm:w-fit'>
            <h3>Saldo disponible:</h3>
            <span>$6000</span>
           </div>
           <div className="group flex flex-col gap-6 mb-28 items-center ">
           {USER_COINS.map( (coin, idx)=> {
            return(
             <div key={idx} className="flex  bg-secondary dark:bg-secondary/90 justify-center rounded-lg items-center py-7 w-3/5 font-bold text-center" >
